...
#[derive(Debug)]
pub struct SyncScramServer<S: ScramHashing, A: ScramAuthServer<S>, B: ScramCbHelper>
{
...
impl<S: ScramHashing, A: ScramAuthServer<S>, B: ScramCbHelper> ScramServerDyn 
for SyncScramServer<S, A, B>
{
